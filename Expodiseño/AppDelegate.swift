...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func buildNavigationDrawer(){
        ...
        var mainPage:PrincipalViewController = mainStoryboard.instantiateViewController(withIdentifier: "PrincipalViewController") as! PrincipalViewController
        
        var leftSideMenu:LeftSideViewController = mainStoryboard.instantiateViewController(withIdentifier: "LeftSideViewController") as! LeftSideViewController
        
        var rightSideMenu:RightSideViewController = mainStoryboard.instantiateViewController(withIdentifier: "RightSideViewController") as! RightSideViewController
